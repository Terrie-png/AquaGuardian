...
// export default class BuyCarParts extends Component
// {
//     constructor(props)
//     {
//         super(props)
...
//     {      
//         axios.post(`${SERVER_HOST}/sales/${paymentData.orderID}/${this.props.partID}/${this.props.price}`, {headers:{"authorization":localStorage.token, "Content-type": "multipart/form-data"}})
//         .then(res => 
//         {                   
